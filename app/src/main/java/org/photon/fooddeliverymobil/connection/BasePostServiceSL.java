...
public abstract class BasePostServiceSL<T>  implements PostListener<T> {
	...
	public BasePostServiceSL(Context appContext, BaseServiceListener<T> listener, String serviceResUri) {
		// Base Constructor
